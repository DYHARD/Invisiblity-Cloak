...
cv2.createTrackbar("H min","TrackBar",1,179,NULL)
cv2.createTrackbar("H max","TrackBar",9,179,NULL)
cv2.createTrackbar("S min","TrackBar",74,255,NULL)
cv2.createTrackbar("S max","TrackBar",121,255,NULL)
cv2.createTrackbar("V min","TrackBar",0,255,NULL)
cv2.createTrackbar("V max","TrackBar",140,255,NULL)
while True:
