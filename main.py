...
import time
import numpy as np
url = "http://10.196.6.172:8080/video"

cap = cv2.VideoCapture(0)
colors=[[17,125,10,98,111,255]]
...
while cap.isOpened():
    ...
    lower_bound = np.array([colors[0][0], colors[0][2], colors[0][4]])
    upper_bound = np.array([colors[0][1], colors[0][3], colors[0][5]])
